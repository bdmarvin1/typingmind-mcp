...
const GOOGLE_AWARE_CLIENT_IDS = ['mcp-server-gsc', 'ga4-node-service', 'GoogleBusinessProfile', 'Memory']; 
...
async function start(authToken) {
  ...
  app.get('/oauth/google/initiate', (req, res) => {
    ...
    const scopes = [
      ...
      'https://www.googleapis.com/auth/drive.file', // For Google Drive (per-file access)
